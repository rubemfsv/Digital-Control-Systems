; Codigo em assembly que faz o acionamento retentivo de um led, ou seja, quando o botão for pressionado e solto, o led deve mudar o seu estado e permanecer nele até que outra sequência de pressionar e soltar ocorra
